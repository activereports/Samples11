Public Class ParameterReport
    ...
    Protected Sub Calendar1_SelectionChanged(ByVal sender As Object, ByVal e As EventArgs)
        ...
        DirectCast(_rpt.DataSource, Data.OleDBDataSource).SQL = "SELECT * FROM orders INNER JOIN [order details] ON orders.orderid = [order details].orderid WHERE orderdate = #" + Calendar1.SelectedDate.ToShortDateString() + "#"
    End Sub
End Class
