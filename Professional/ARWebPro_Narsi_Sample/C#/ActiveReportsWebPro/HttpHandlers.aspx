<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HttpHandlers.aspx.cs" Inherits="GrapeCity.ActiveReports.Samples.Web.Professional.HttpHandlers" %>
            ...
            <div>
                <p>
                    ...
                    <p>
                        For example:</p>
                    <ul>
                        <li><a href="http://localhost:4600/ActiveReportsWebPro/GrapeCity.ActiveReports.Samples.Web.Professional.CodeReports.Invoice.ActiveReport?OutputFormat=PDF">
                        ...
                        <li><a href="http://localhost:4600/ActiveReportsWebPro/GrapeCity.ActiveReports.Samples.Web.Professional.CodeReports.NwindLabels.ActiveReport?OutputFormat=HTML">
                    ...
                    <ul>
                        <li><a href="http://localhost:4600/ActiveReportsWebPro/GrapeCity.ActiveReports.Samples.Web.Professional.CodeReports.InvoiceFiltered.ActiveReport?StartingDate=9-1-1994&EndingDate=9-5-1994">
                        ...
                        <li><a href="http://localhost:4600/ActiveReportsWebPro/GrapeCity.ActiveReports.Samples.Web.Professional.CodeReports.NwindLabelsFiltered.ActiveReport?Country=USA">
