Namespace CodeReports
    ...
    Partial Public Class InvoiceFiltered
        ...
        Private Sub InitializeComponent()
            ...
            Me.PageHeader.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.lblNorthWind, Me.lblTraders, Me.lblNWAddr1, Me.lblNWAddr2, Me.lblInvoice, Me.Label1, Me.txtOrderID, Me.Label2, Me.txtOrderDate, Me.imgLogo})
            ...
            OleDBDataSource1.SQL = "SELECT * FROM Invoices " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE ((OrderDate >= #<%StartingDate|Starting Date:|8-1-" & _
                "1994|D%>#) AND (OrderDate <= #<%EndingDate|Ending Date:|9-1-1994|D%>#))" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "ORDER B" & _
                "Y OrderID"
