<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="HttpHandlers.aspx.vb" Inherits="GrapeCity.ActiveReports.Samples.Web.Professional.HttpHandlers" %>
            ...
            <div>
                <p>
                    ...
                    <ul>
                        ...
                        <li><a href="RpxReports/InvoiceFiltered.rpx?StartingDate=9-1-1994&EndingDate=9-5-1994">
                            Invoice.<span style="color: red">rpx</span>?<span style="color: red">?StartingDate=9-1-1994&EndingDate=9-5-1994</span></a>
                        </li>
                    </ul>
            ...
            <div>
                <p>
                    ...
                    <p>
                        For example:</p>
                    <ul>
                        <li><a href="http://localhost:4707/ActiveReportsWebPro/GrapeCity.ActiveReports.Samples.Web.Professional.CodeReports.Invoice.ActiveReport?OutputFormat=PDF">
                        ...
                        <li><a href="http://localhost:4707/ActiveReportsWebPro/GrapeCity.ActiveReports.Samples.Web.Professional.CodeReports.NwindLabels.ActiveReport?OutputFormat=HTML">
                    ...
                    <ul>
                        <li><a href="http://localhost:4707/ActiveReportsWebPro/GrapeCity.ActiveReports.Samples.Web.Professional.CodeReports.InvoiceFiltered.ActiveReport?StartingDate=9-1-1994&EndingDate=9-5-1994">
                            /<span style="color: red;">ActiveReportsWebPro</span>/<span style="color: green;">GrapeCity.ActiveReports.Samples.WebReports.InvoiceFiltered</span>.ActiveReport?<span
                                style="color: red;">StartingDate=9-1-1994&EndingDate=9-5-1994</span> </a>
                        </li>
                        <li><a href="http://localhost:4707/ActiveReportsWebPro/GrapeCity.ActiveReports.Samples.Web.Professional.CodeReports.NwindLabelsFiltered.ActiveReport?Country=USA">
