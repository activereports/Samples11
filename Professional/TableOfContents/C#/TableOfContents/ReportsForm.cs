...
namespace GrapeCity.ActiveReports.Samples.TableOfContents
{
    public partial class ReportsForm : Form
    {
        ...
        static ReportsForm()
        {
            XDocument loaded = XDocument.Load("TableOfContents.config");
        ...
        private void FolderLocalization()
        {
            ...
            StreamReader reader = new StreamReader(new FileStream(@"..\..\TableOfContents.config", FileMode.Open, FileAccess.Read, FileShare.Read));
