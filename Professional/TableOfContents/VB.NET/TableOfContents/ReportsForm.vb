...
Public Class ReportsForm
    ...
    Private Sub FolderLocalization()
        ...
        Dim reader As New StreamReader(New FileStream("..\..\TableOfContents.config", FileMode.Open, FileAccess.Read, FileShare.Read))
    ...
    Public Sub New()
        ...
        Dim item As ToolStrip = CreateReportToolbar()
        ...
        Dim loaded As XDocument = XDocument.Load("TableOfContents.config")
    ...
    Private Sub OnExit(ByVal sender As Object, ByVal e As EventArgs)
        Close()
    End Sub
    'Check whether modifications have been made to the report loaded in the designerデザイナに読み込んだレポートが更新されたかどうかを確認します。
    ...
    Private Function CreateReportToolbar() As ToolStrip
        Return New ToolStrip(New ToolStripButton() {CreateToolStripButton(My.Resources.NewText, My.Resources.CmdNewReport, New EventHandler(AddressOf OnNew), My.Resources.NewText), ReportsForm.CreateToolStripButton(My.Resources.OpenText, My.Resources.CmdOpen, New EventHandler(AddressOf OnOpen), My.Resources.OpenText), ReportsForm.CreateToolStripButton(My.Resources.SaveText, My.Resources.CmdSave, New EventHandler(AddressOf OnSave), My.Resources.SaveText)})
    End Function
