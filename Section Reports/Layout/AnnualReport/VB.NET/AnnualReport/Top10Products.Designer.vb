 _
Partial Class Top10Products
    Inherits GrapeCity.ActiveReports.SectionReport
Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Top10Products))
        ...
        Me.chtProducts = New GrapeCity.ActiveReports.SectionReportModel.ChartControl()
        ...
        'chtProducts
        Me.chtProducts.AutoRefresh = True
        Me.chtProducts.Backdrop = New GrapeCity.ActiveReports.Chart.BackdropItem(GrapeCity.ActiveReports.Chart.Graphics.GradientType.Vertical, System.Drawing.Color.White, System.Drawing.Color.LightYellow)
        ...
        Axis3.LabelsGap = 0
        Axis3.MajorTick = New GrapeCity.ActiveReports.Chart.Tick(New GrapeCity.ActiveReports.Chart.Graphics.Line(System.Drawing.Color.Firebrick), New GrapeCity.ActiveReports.Chart.Graphics.Line(System.Drawing.Color.Firebrick, GrapeCity.ActiveReports.Chart.Graphics.LineStyle.None), 50000.0R, 3.0!, True)
        Axis3.Min = 0.0R
        ...
        Me.chtProducts.ChartAreas.AddRange(New GrapeCity.ActiveReports.Chart.ChartArea() {ChartArea1})
        Me.chtProducts.ChartBorder = New GrapeCity.ActiveReports.Chart.Border(New GrapeCity.ActiveReports.Chart.Graphics.Line(System.Drawing.Color.Transparent, 0, GrapeCity.ActiveReports.Chart.Graphics.LineStyle.None), 0, System.Drawing.Color.Black)
        Me.chtProducts.ColorPalette = GrapeCity.ActiveReports.Chart.ColorPalette.Cascade
        resources.ApplyResources(Me.chtProducts, "chtProducts")
        ...
        Me.chtProducts.Legends.AddRange(New GrapeCity.ActiveReports.Chart.Legend() {Legend1})
        Me.chtProducts.Name = "chtProducts"
        Series1.AxisX = Axis1
        Series1.AxisY = Axis3
        ...
        Series1.ValueMemberX = "ProductName"
        Me.chtProducts.Series.AddRange(New GrapeCity.ActiveReports.Chart.Series() {Series1})
        ...
        Title4.Name = "footer"
        Title4.Text = ""
        Me.chtProducts.Titles.AddRange(New GrapeCity.ActiveReports.Chart.Title() {Title3, Title4})
        Me.chtProducts.UIOptions = GrapeCity.ActiveReports.Chart.UIOptions.ForceHitTesting
        'Detail
        Me.Detail.ColumnSpacing = 0.0!
        Me.Detail.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.txtProductName, Me.txtSales, Me.lblRank})
        Me.Detail.Height = 0.1875!
        Me.Detail.KeepTogether = True
        Me.Detail.Name = "Detail"
        'GroupHeader1
        Me.GroupHeader1.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.chtProducts})
...
Private chtProducts As GrapeCity.ActiveReports.SectionReportModel.ChartControl
