...
Public Class StartForm
    ...
    End Sub 'Main
    'btnCustomers_Click - Checks the radio options and sets the report object's databtnCustomers_Clickイベントでラジオボタンを選択し、レポートのオブジェクトのデータを設定します。
