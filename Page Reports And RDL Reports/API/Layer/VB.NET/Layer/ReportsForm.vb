...
Public Class ReportsForm
    ...
    Private Sub CreateFileMenu(ByVal fileMenu As ToolStripDropDownItem)
        ...
        fileMenu.DropDownItems.Add(New ToolStripMenuItem(My.Resources.Resource.ExportText, Nothing, New EventHandler(AddressOf OnExport), (Keys.Control Or Keys.E)))
    ...
    Private Sub OnEnableExport(ByVal sender As Object, ByVal eventArgs As EventArgs)
        If reportDesigner.ReportType <> DesignerReportType.Section Then
            ...
            _item.Items(3).Enabled = reportDesigner.ActiveTab = DesignerTab.Preview
        End If
    End Sub
