...
namespace GrapeCity.ActiveReports.Samples.Layer
{
    public partial class ReportsForm : Form
    {
        ...
        private void CreateFileMenu(ToolStripDropDownItem fileMenu)
        {
            ...
            fileMenu.DropDownItems.Add(new ToolStripMenuItem(Properties.Resources.ExportText, null, new EventHandler(OnExport), (Keys.Control | Keys.E)));
        ...
        private ToolStrip CreateReportToolbar()
        {
            ...
            { 
				...
				CreateToolStripButton(Properties.Resources.ExportText,null,new EventHandler(OnExport),Properties.Resources.ExportText,ToolStripItemDisplayStyle.Text) ,
            });
        }
