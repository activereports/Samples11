...
Imports GrapeCity.ActiveReports.Extensibility.Definition.Components
...
Imports GrapeCity.ActiveReports.Expressions
Imports System.Globalization
    ...
    Private Shared Sub CreateTableColumns(ByVal state As ReportWizardState, ByVal table As Table)
        If table.TableColumns.Count > 0 Then
            Throw New ArgumentException("The table already has columns in it", "table")
        End If
        Dim columns As New List(Of FieldMetaData)()
        columns.AddRange(state.GroupingFields)
        columns.AddRange(state.DisplayFields)
    ...
    Private Shared Function CreateTextBox() As TextBox
        ...
        textBox.Style.PaddingBottom = "2pt"
        textBox.Style.PaddingLeft = "2pt"
        textBox.Style.PaddingRight = "2pt"
        textBox.Style.PaddingTop = "2pt"
        Return textBox
    End Function
