...
Namespace UI
    Public Class DragDropListBox
        ...
        <Description("Raised when the control needs to know what data should be dragged from the control.")> _
        ...
        <Browsable(True)> _
        <Category("Drag Drop")> _
        <Description("Raised when the drag and drop operation has completed.")> _
